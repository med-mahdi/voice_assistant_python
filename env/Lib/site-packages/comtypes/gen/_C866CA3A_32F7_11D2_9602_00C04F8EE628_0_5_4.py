...
__all__ = [
    'DISPID_SABufferInfo', 'DISPID_SRAudioInput',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPIEngineId',
    'SAFTADPCM_8kHzStereo', 'SRERecognition',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPIElements',
    'eLEXTYPE_PRIVATE15', 'SAFT48kHz16BitMono', 'DISPID_SLPsCount',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SPIProperties',
    'SPEI_SR_AUDIO_LEVEL', 'SP_VISEME_0', 'SVP_4',
    'DISPID_SABufferNotifySize', 'DISPID_SRCEHypothesis',
    ...
    'DISPID_SABIBufferSize', 'ISpeechRecoResultTimes', 'SPAR_Unknown',
    'SpInprocRecognizer', 'SREAdaptation', 'ISpDataKey',
    'SREPhraseStart', 'SVSFIsFilename', 'SpeechVoiceSpeakFlags',
    'SPAO_RETAIN_AUDIO', 'SPPS_Interjection', 'SPPS_Unknown',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPSERIALIZEDPHRASE',
    'DISPIDSPTSI_SelectionOffset', '_SPAUDIOSTATE',
    'DISPID_SPRuleNumberOfElements', 'SITooLoud', 'DISPID_SRCVoice',
    'SpeechTokenKeyUI', 'SPPROPERTYINFO', 'SAFT24kHz16BitStereo',
    'SPAS_STOP', 'DISPID_SRCRecognizer', 'SLTUser',
    'DISPID_SPPBRestorePhraseFromMemory', 'SP_VISEME_5',
    'SRERequestUI', 'SPAR_High', 'DISPID_SLGenerationId',
    ...
    'SpeechAddRemoveWord', 'DISPID_SOTRemoveStorageFileName',
    'Speech_Max_Word_Length', 'STSF_FlagCreate', 'SpeechRunState',
    'SREStreamStart', 'SSTTTextBuffer', 'SpAudioFormat', 'SAFTText',
    'ISpRecognizer2', 'SAFT32kHz8BitMono',
    'DISPID_SVSCurrentStreamNumber', 'SpeechEmulationCompareFlags',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPIGrammarId',
    'SRARoot', 'SGRSTTEpsilon', 'SAFT16kHz8BitStereo',
    'DISPID_SpeechPhraseProperties', 'DISPID_SGRAttributes',
    'SGRSTTWildcard', 'SINoise', 'DISPID_SOTGetStorageFileName',
    'ISpeechPhoneConverter', 'ISpeechPhraseProperty',
    'SAFTGSM610_8kHzMono', 'SLODynamic', 'SpeechCategoryRecognizers',
    'SPPS_RESERVED1', 'DISPID_SRSetPropertyNumber',
    'SpeechVoicePriority', 'SpeechRetainedAudioOptions',
    'SpeechPropertyAdaptationOn', 'SPFM_OPEN_READWRITE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechPhraseRule',
    'WAVEFORMATEX', 'SPSHT_OTHER', 'ISpVoice',
    'DISPID_SPANumberOfElementsInResult', 'SREAudioLevel',
    'SpNullPhoneConverter', 'SVEPrivate', 'SDA_One_Trailing_Space',
    'SAFT48kHz16BitStereo', 'SP_VISEME_17', 'DISPID_SpeechPhraseRule',
    'ISpeechRecoGrammar', 'SPWORDLIST', 'SpeechDataKeyLocation',
    'SPEI_HYPOTHESIS', 'DISPID_SPPName', 'SpeechPartOfSpeech',
    'eLEXTYPE_PRIVATE2', 'SAFT22kHz8BitStereo', 'SAFT8kHz8BitStereo',
    'SRESoundStart', 'eLEXTYPE_RESERVED4', 'ISpNotifySource',
    'SWTAdded', 'DISPID_SVGetVoices', 'SAFTCCITT_ALaw_44kHzMono',
    'SPEI_TTS_BOOKMARK', 'SRADefaultToActive',
    'SAFTCCITT_uLaw_22kHzMono', 'SGDSActiveUserDelimited',
    'SVF_Stressed', 'SAFT44kHz8BitMono', 'SPEI_RECOGNITION',
    'DISPID_SGRSTsCount', 'SPPARTOFSPEECH',
    'DISPID_SpeechPhraseRules', 'DISPID_SRRTLength',
    'DISPID_SDKGetlongValue', 'SGSExclusive',
    'DISPID_SpeechPhraseProperty', 'SVSFParseMask', 'SDTAll',
    'SAFTCCITT_uLaw_44kHzMono', 'SECFNoSpecialChars',
    'ISpEventSource', 'SPSNoun', 'Speech_Default_Weight',
    'SRATopLevel', 'SpeechAudioVolume', 'DISPID_SRCState',
    'STSF_CommonAppData', 'DISPID_SPEActualConfidence',
    'DISPID_SpeechFileStream', 'SPPHRASEPROPERTY',
    'DISPID_SRGSetWordSequenceData', 'SASPause', 'SVEBookmark',
    'SDA_Two_Trailing_Spaces', 'SPPS_Noun', 'DISPID_SRGetRecognizers',
    'SPAS_PAUSE', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechAllElements', 'SPEVENTENUM', 'eLEXTYPE_RESERVED6',
    'SVSFNLPMask', 'DISPID_SCSBaseStream', 'DISPID_SGRsDynamic',
    'SpeechDictationTopicSpelling', 'SRERecoOtherContext',
    'SAFTGSM610_44kHzMono', 'SVEAllEvents',
    'DISPID_SRSetPropertyString', 'DISPID_SGRInitialState',
    'DISPID_SLWs_NewEnum', 'DISPID_SRCBookmark', 'DISPID_SLWsItem',
    'SAFTADPCM_44kHzStereo', 'eLEXTYPE_PRIVATE16',
    'IEnumSpObjectTokens', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SPRuleFirstElement', 'SPADAPTATIONRELEVANCE',
    'ISpeechAudioStatus', 'SPVPRI_OVER', 'ISpAudio',
    'SpeechCategoryVoices', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SpeechVoiceEvent', 'SGRSTTTextBuffer',
    'SpeechEngineProperties', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRGDictationSetState', 'SECFIgnoreKanaType',
    'ISpeechPhraseElements', 'DISPID_SDKCreateKey',
    'DISPID_SMSALineId', 'DISPID_SRCSetAdaptationData',
    'SRSInactiveWithPurge', 'SREPrivate', 'SPEI_SOUND_END',
    ...
    'SAFTADPCM_11kHzMono', 'SAFT48kHz8BitStereo', 'SVSFlagsAsync',
    'ISpeechBaseStream', 'ISpRecoGrammar2', 'DISPID_SLPLangId',
    'Speech_StreamPos_RealTime', 'SREHypothesis',
    'DISPID_SLPPartOfSpeech', 'SPPHRASERULE', 'SPSVerb',
    'SAFTADPCM_8kHzMono', 'SPSHT_EMAIL', 'SPCONTEXTSTATE',
    'SGPronounciation', 'SRESoundEnd', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRCCreateResultFromMemory', 'SpeechAudioState',
    'DISPID_SRRAlternates', 'SRAImport', 'DISPID_SMSADeviceId',
    'DISPID_SRCEventInterests', 'SRAInterpreter', 'SVEVoiceChange',
    'ISpeechPhraseProperties', 'SpSharedRecoContext',
    'DISPID_SOTGetAttribute', 'DISPID_SMSAMMHandle',
    'ISpeechPhraseAlternates', 'SpeechRuleAttributes',
    'DISPID_SPRText', 'SpUnCompressedLexicon', 'SP_VISEME_19',
    'SPSHORTCUTPAIR', 'SVP_11', 'DISPID_SRGState', 'SLOStatic',
    'ISequentialStream', 'ISpeechDataKey', 'DISPID_SLWsCount',
    'SPEI_START_SR_STREAM', 'DISPID_SVRate',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPEs_NewEnum',
    'ISpProperties', 'SpeechCategoryAppLexicons', 'DISPID_SPPId',
    'DISPID_SpeechLexicon', 'eLEXTYPE_MORPHOLOGY', 'SpeechLoadOption',
    'SpeechVoiceCategoryTTSRate', 'SRCS_Enabled',
    'DISPID_SOTs_NewEnum', 'SpPhoneticAlphabetConverter',
    'DISPID_SGRSTType', 'DISPID_SpeechPhraseReplacements',
    'SVSFVoiceMask', 'SpeechGrammarRuleStateTransitionType',
    'SINoSignal', 'DISPID_SRCEStartStream',
    'DISPID_SPERetainedStreamOffset', 'SAFT22kHz8BitMono',
    'DISPID_SABIEventBias', 'DISPID_SPCIdToPhone',
    'SPEI_WORD_BOUNDARY', 'DISPID_SPIEnginePrivateData', 'SASClosed',
    'SpPhraseInfoBuilder', 'SpSharedRecognizer',
    'DISPID_SVAudioOutputStream', 'DISPID_SDKEnumValues',
    'ISpObjectWithToken', 'SVSFPersistXML', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechVoiceStatus', 'SPAR_Low', 'SPINTERFERENCE_TOOQUIET',
    'SPPS_LMA', 'SPEI_REQUEST_UI', 'SpStreamFormatConverter',
    'DISPID_SpeechPhraseAlternates', 'SpeechEngineConfidence',
    'DISPID_SVEVoiceChange', 'DISPID_SPAsItem', 'SVSFParseSsml',
    'SRTSMLTimeout', 'SPCATEGORYTYPE', 'DISPID_SVPause',
    'DISPID_SPCLangId', 'SP_VISEME_4', 'ISpeechPhraseAlternate',
    'SAFTNoAssignedFormat', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVSVisemeId', 'DISPID_SPPNumberOfElements',
    'SAFTCCITT_ALaw_8kHzStereo', 'SRTStandard', 'SBOPause',
    'SpeechRuleState', 'DISPID_SRGDictationLoad',
    'DISPID_SRCRequestedUIType', 'DISPID_SGRSTNextState', 'SVP_14',
    'DISPID_SVSyncronousSpeakTimeout', 'SDTProperty',
    'DISPID_SBSSeek', 'SpStream', 'DISPID_SVEStreamEnd',
    'DISPID_SRRecognizer', 'SVP_21', 'ISpeechObjectTokens',
    'DISPID_SPACommit', 'SSFMOpenForRead', 'DISPID_SLPPhoneIds',
    'DISPID_SGRSRule', 'ISpeechAudio', 'DISPID_SGRSTText', 'SVP_6',
    'DISPID_SOTCDefault', 'DISPID_SGRClear', 'SpeechRecognitionType',
    'SpeechRecoProfileProperties', 'DISPID_SPIGetText',
    'SAFT48kHz8BitMono', 'DISPID_SPRsCount',
    ...
    'SPPHRASEREPLACEMENT', 'SASStop', 'SVP_18',
    'DISPID_SpeechPhraseInfo', 'SITooQuiet', 'DISPID_SRRTimes',
    'SGSEnabled', 'ISpRecoContext2', 'SpeechAudioFormatGUIDWave',
    'SPPS_NotOverriden', 'SpMMAudioOut', 'SPWORDPRONOUNCEABLE',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRCEEndStream',
    'ISpRecoCategory', 'DISPID_SVIsUISupported',
    'DISPID_SpeechPhoneConverter', 'DISPID_SpeechRecoContext',
    'SAFTExtendedAudioFormat', 'ISpShortcut',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SpeechXMLRecoResult',
    'ISpRecognizer3', 'SPRS_ACTIVE_USER_DELIMITED',
    'eWORDTYPE_DELETED', 'SRTEmulated', 'SpFileStream',
    'eLEXTYPE_USER', 'SGDSInactive', 'SREBookmark',
    'SpeechCategoryAudioOut', 'DISPID_SRGRules',
    'SSSPTRelativeToCurrentPosition', 'SGRSTTDictation', 'SVP_16',
    ...
    'SAFT44kHz16BitStereo', 'DISPID_SAStatus', 'DISPID_SPPsCount',
    'DISPID_SVSLastBookmarkId', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPRULE', 'SWTDeleted', 'SPXMLRESULTOPTIONS', 'DISPID_SRCPause',
    'SVSFNLPSpeakPunc', 'eLEXTYPE_APP', 'eLEXTYPE_RESERVED10',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRRTTickCount',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SLWPronunciations',
    'SPBO_PAUSE', 'DISPID_SAVolume', 'DISPID_SLPsItem',
    'SECHighConfidence', 'SP_VISEME_18', 'SVPOver', 'SPAUDIOOPTIONS',
    'DISPID_SpeechDataKey', 'SVP_3', 'DISPID_SGRSTWeight', 'SVP_20',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRCAudioInInterferenceStatus',
    'SpeechBookmarkOptions', 'SPSUnknown', 'SAFTADPCM_44kHzMono',
    'SRAONone', 'DISPID_SpeechRecoResultTimes', 'ISpMMSysAudio',
    'DISPID_SVEViseme', 'SpMMAudioIn', 'DISPID_SGRSTransitions',
    'SAFTGSM610_11kHzMono', 'SPLO_DYNAMIC', 'DISPID_SLPType',
    'SAFT8kHz16BitStereo', 'SP_VISEME_1', 'ISpSerializeState',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRCEFalseRecognition',
    'DISPID_SWFEFormatTag', 'DISPID_SVAlertBoundary',
    'DISPID_SVSpeak', 'SpeechTokenShellFolder', 'DISPID_SLWWord',
    'DISPID_SRCEAdaptation', 'ISpEventSink', 'eLEXTYPE_PRIVATE17',
    'DISPID_SPPChildren', 'SpeechTokenKeyAttributes',
    'DISPID_SPRulesCount', 'SpObjectTokenCategory',
    'ISpeechAudioFormat', 'SPCT_COMMAND',
    'SpTextSelectionInformation', 'SAFTADPCM_11kHzStereo',
    'ISpGrammarBuilder', 'SPVOICESTATUS', 'DISPID_SPIRule',
    ...
    '_ISpeechRecoContextEvents', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRCRetainedAudio', 'SGDisplay', 'SpeechDiscardType',
    'DISPID_SRState', 'SPRECOSTATE', 'DISPID_SPRulesItem',
    'DISPID_SOTDataKey', 'DISPID_SVEAudioLevel',
    'SPXRO_Alternates_SML', 'STCInprocServer', 'SVEViseme',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPRDisplayAttributes', 'DISPID_SOTCategory',
    'ISpResourceManager', 'SPSFunction', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SGRSTRule', 'SpVoice', 'SPEI_RESERVED6',
    'DISPID_SGRSAddRuleTransition', 'SSTTDictation',
    'DISPID_SRGCmdSetRuleState', 'SREAllEvents',
    'ISpObjectTokenCategory', 'DISPID_SRGetPropertyString',
    'DISPID_SVSpeakCompleteEvent', 'SPAUDIOSTATUS',
    'ISpeechObjectToken', 'DISPID_SPPsItem', 'SVP_15',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SGRsFindRule',
    'SRADynamic', 'SAFT8kHz8BitMono', 'SECNormalConfidence',
    'DISPID_SLGetPronunciations', 'SPRST_INACTIVE',
    'SpeechAudioProperties', 'SRTReSent', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVDisplayUI', 'SPSHORTCUTTYPE',
    'DISPID_SpeechWaveFormatEx', 'SPEI_START_INPUT_STREAM',
    'SPEI_VOICE_CHANGE', 'DISPID_SOTRemove', 'SPDATAKEYLOCATION',
    'eLEXTYPE_PRIVATE11', 'SAFT12kHz8BitStereo', 'SDTAlternates',
    'ISpeechPhraseElement', 'IInternetSecurityMgrSite',
    'DISPID_SRGReset', 'DISPID_SGRSTPropertyName', 'SRAORetainAudio',
    ...
    'IEnumString', 'SPEI_MIN_SR', 'eLEXTYPE_USER_SHORTCUT',
    'SPWT_LEXICAL', 'SPXRO_SML', 'SPWF_INPUT',
    'DISPID_SpeechRecognizerStatus', 'ISpeechObjectTokenCategory',
    'ISpeechVoice', 'DISPID_SPRFirstElement', 'ISpeechLexiconWord',
    'DISPID_SRGSetTextSelection', 'DISPID_SRIsShared', 'SRAExport',
    'SpeechRecoEvents', 'DISPID_SpeechPhraseBuilder',
    'SPPS_Noncontent', 'SPRS_ACTIVE', 'DISPID_SPRuleConfidence',
    'SPEI_RESERVED3', 'SAFT8kHz16BitMono', '__MIDL_IWinTypes_0009',
    'SpeechRegistryLocalMachineRoot', 'SPSInterjection',
    'DISPID_SGRAddResource', 'DISPID_SRIsUISupported',
    'DISPID_SPRuleId', 'ISpeechRecoResult', 'DISPID_SVSpeakStream',
    'SP_VISEME_21', 'SPGS_EXCLUSIVE', 'SECFDefault', 'SPPS_Modifier',
    'SRTExtendableParse', 'DISPID_SpeechBaseStream', 'SPGS_DISABLED',
    'DISPID_SVSInputSentenceLength', 'ISpeechPhraseRules',
    'DISPID_SRGCmdLoadFromObject', 'SPWORD', 'DISPID_SpeechAudio',
    'ISpeechFileStream', 'DISPID_SpeechLexiconWords',
    'ISpeechRecoContext', 'DISPID_SAFGetWaveFormatEx',
    'SPAUDIOBUFFERINFO', 'DISPID_SGRsCount',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRProfile',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRRDiscardResultInfo',
    'SVP_8', 'SAFTNonStandardFormat', 'ISpeechGrammarRule',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SASNonBlockingIO',
    'SPBO_AHEAD', 'SPPS_Verb', 'DISPID_SLPs_NewEnum',
    'SDTPronunciation', 'SWPKnownWordPronounceable',
    'SECFIgnoreWidth', 'SPINTERFERENCE_TOOSLOW', 'SpeechVoiceEvents',
    'DISPID_SPAPhraseInfo', 'SPSHORTCUTPAIRLIST',
    ...
    'DISPID_SDKEnumKeys', 'SPPS_RESERVED3',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRAudioInputStream',
    'SPDKL_CurrentUser', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPEI_PHONEME',
    'DISPID_SADefaultFormat', 'SITooFast',
    'DISPID_SPIAudioStreamPosition', 'SpeechCategoryAudioIn',
    'ISpeechAudioBufferInfo', 'SVP_2', 'SPBO_NONE', 'DISPID_SPEsItem',
    'SAFT24kHz8BitStereo', 'DISPID_SpeechGrammarRuleState',
    'SP_VISEME_8', 'SVSFUnusedFlags', 'SVSFPurgeBeforeSpeak',
    'DISPID_SVResume', 'ISpeechLexiconWords',
    'SpeechAudioFormatGUIDText', 'DISPID_SPILanguageId',
    'DISPID_SPPConfidence', 'SVP_12', 'DISPID_SOTGetDescription',
    'SpeechPropertyResourceUsage', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SVGetProfiles',
    'DISPID_SVSLastResult', 'SPAR_Medium', 'SPSModifier',
    'DISPID_SRGCmdLoadFromFile', 'ISpeechXMLRecoResult',
    'DISPID_SRRAudioFormat', 'DISPID_SRGId', 'DISPID_SPRuleChildren',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SAFT44kHz8BitStereo',
    'DISPID_SRGCommit', 'SVP_10', 'SGDSActiveWithAutoPause',
    'SpeechPropertyLowConfidenceThreshold', 'eLEXTYPE_PRIVATE5',
    'DISPID_SVGetAudioInputs', 'ISpStreamFormatConverter',
    'DISPID_SDKDeleteKey', 'eLEXTYPE_PRIVATE14', 'SDTAudio',
    'SAFT12kHz8BitMono', 'SVEAudioLevel', 'eLEXTYPE_PRIVATE8',
    'SPLO_STATIC', 'SP_VISEME_3', 'SPWORDPRONUNCIATION',
    ...
    'SpResourceManager', 'SPVISEMES', 'ISpeechMemoryStream',
    'SPCS_DISABLED', 'DISPID_SRRSpeakAudio', 'SPEI_INTERFERENCE',
    'DISPID_SBSFormat', 'DISPID_SRCEPhraseStart',
    'SAFT11kHz16BitMono', 'SAFT44kHz16BitMono', 'DISPID_SPRs_NewEnum',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SABIMinNotification',
    'SDTReplacement', 'DISPID_SRRRecoContext',
    'eLEXTYPE_VENDORLEXICON', 'ISpPhraseAlt', 'DISPID_SVEPhoneme',
    'SPSLMA', 'SpeechWordPronounceable', 'DISPID_SpeechAudioStatus',
    'ISpLexicon', 'DISPID_SRRTStreamTime', 'DISPID_SRRAudio',
    'DISPID_SWFEAvgBytesPerSec', 'SpeechTokenValueCLSID',
    'SpeechUserTraining', 'Speech_StreamPos_Asap', 'SP_VISEME_16',
    'SPVPRI_NORMAL', 'DISPID_SRCESoundStart', 'SP_VISEME_6',
    'ISpeechPhraseInfoBuilder', 'SPEI_SR_BOOKMARK',
    'DISPID_SVEStreamStart', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechGrammarRule', 'SDA_No_Trailing_Space',
    'ISpPhoneticAlphabetSelection', 'SpeechVisemeType',
    'SPTEXTSELECTIONINFO', 'DISPID_SPRules_NewEnum',
    'SPFM_CREATE_ALWAYS', 'SVP_7', 'SP_VISEME_15', 'DISPID_SPPValue',
    'DISPID_SRRSaveToMemory', 'SSFMCreate', 'DISPID_SPAsCount',
    'SAFTADPCM_22kHzStereo', 'SP_VISEME_14', 'SpLexicon',
    'SRSActiveAlways', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRSAudioStatus', 'SDKLLocalMachine', 'SDKLCurrentUser',
    'Speech_Max_Pron_Length', 'ISpeechRecoResultDispatch',
    'DISPID_SFSOpen', 'SPEI_PROPERTY_NUM_CHANGE', 'SP_VISEME_20',
    'DISPID_SOTDisplayUI', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRCERecognition', 'DISPID_SPARecoResult', 'SGDSActive',
    'DISPID_SPEEngineConfidence', 'SPWAVEFORMATTYPE', 'SP_VISEME_11',
    'ISpeechTextSelectionInformation', 'ISpRecoContext',
    'SAFT12kHz16BitStereo', 'DISPID_SMSSetData',
    'DISPID_SDKGetBinaryValue', 'DISPID_SWFESamplesPerSec',
    'DISPID_SLGetWords', 'DISPID_SMSGetData',
    'IInternetSecurityManager', 'DISPID_SRRSetTextFeedback',
    'DISPID_SVEEnginePrivate', 'SINone',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVSRunningState', 'ISpeechCustomStream',
    'SWPUnknownWordPronounceable', 'eLEXTYPE_PRIVATE18',
    'DISPID_SVVolume', 'SPEI_TTS_PRIVATE', 'eLEXTYPE_PRIVATE1',
    'DISPID_SVESentenceBoundary', 'SVPNormal', 'SPEVENTSOURCEINFO',
    'DISPID_SPEAudioSizeTime', 'SVSFIsXML', 'SPFM_CREATE',
    'DISPID_SRDisplayUI', 'SREStateChange', 'DISPID_SRStatus',
    'DISPID_SVGetAudioOutputs', 'DISPID_SpeechLexiconProns',
    'eLEXTYPE_PRIVATE7', 'IStream', 'SDTDisplayText',
    'SpeechWordType', 'eLEXTYPE_PRIVATE4', 'SRSEDone',
    'SAFT22kHz16BitStereo', 'SAFT24kHz8BitMono',
    'DISPID_SRCEBookmark', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SVAudioOutput', 'DISPIDSPRG',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCreateRecoContext',
    'SPEI_END_SR_STREAM', 'DISPID_SDKGetStringValue',
    'DISPID_SPIGetDisplayAttributes', 'ISpRecoGrammar',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVEPhoneme', 'SpeechTokenContext',
    'SPPS_RESERVED4', 'DISPID_SpeechRecoResult',
    'SpeechVisemeFeature', 'DISPID_SPPs_NewEnum',
    'DISPID_SRSClsidEngine', 'DISPID_SVSPhonemeId',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SAFGuid',
    'SpMMAudioEnum', 'SAFTTrueSpeech_8kHz1BitMono',
    'ISpNotifyTranslator', 'SVEStartInputStream', 'SPEI_RESERVED1',
    'SPLEXICONTYPE', 'SDKLDefaultLocation', 'ISpeechRecognizerStatus',
    'DISPID_SGRSTPropertyValue', 'SPEI_ADAPTATION',
    'SPINTERFERENCE_TOOLOUD', 'SPWF_SRENGINE', 'SVP_19',
    'DISPID_SPRuleParent', 'DISPID_SVVoice', 'SPPS_RESERVED2',
    'DISPID_SOTId', 'DISPID_SREmulateRecognition',
    'DISPID_SRGRecoContext', 'SpInProcRecoContext',
    'DISPID_SPEPronunciation', 'SAFT22kHz16BitMono',
    'DISPID_SGRAddState', 'SREPropertyStringChange',
    'DISPID_SAFSetWaveFormatEx', 'ISpPhoneConverter',
    'SPINTERFERENCE_NOISE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT11kHz8BitStereo', 'SPWT_DISPLAY', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SPELexicalForm', 'SPINTERFERENCE', 'SPGRAMMARSTATE',
    'DISPID_SOTSetId', 'DISPID_SRCCreateGrammar',
    'SAFT32kHz8BitStereo', 'eLEXTYPE_PRIVATE9', 'DISPID_SOTCSetId',
    'tagSTATSTG', 'SPCT_SLEEP', 'SPRST_ACTIVE_ALWAYS', 'SP_VISEME_9',
    'SPVPRI_ALERT', 'SPSNotOverriden', 'SGLexical', 'SREStreamEnd',
    'eLEXTYPE_RESERVED8', 'SPEI_PHRASE_START', 'SpeechFormatType',
    'ISpRecognizer', 'SpMemoryStream', 'SAFT11kHz8BitMono',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SASState',
    'SVESentenceBoundary', 'DISPID_SDKSetLongValue',
    'SPEI_SR_RETAINEDAUDIO', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'eLEXTYPE_PRIVATE20', 'DISPIDSPTSI_ActiveLength', 'SVSFParseSapi',
    'ISpXMLRecoResult', 'SRSEIsSpeaking', 'DISPID_SOTsItem',
    'DISPID_SPPFirstElement', 'DISPID_SRCEAudioLevel', 'SPWORDTYPE',
    'DISPID_SpeechPhraseElement', 'DISPID_SVSInputWordPosition',
    'SVEEndInputStream', 'SPRS_INACTIVE',
    'ISpeechLexiconPronunciation', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpeechGrammarRules', 'SPBINARYGRAMMAR',
    'DISPID_SVSLastBookmark', 'SPEI_FALSE_RECOGNITION',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechVoiceStatus',
    'DISPID_SPCPhoneToId', 'SpeechRecoContextState',
    'DISPID_SBSWrite', 'DISPID_SVStatus', 'SpeechGrammarTagDictation',
    'SITooSlow', 'SVF_Emphasis', 'SpeechPropertyResponseSpeed',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechGrammarRules',
    'ISpeechRecoResult2', 'SDKLCurrentConfig', 'SPAS_CLOSED',
    'SPEVENT', 'SAFT12kHz16BitMono', 'SDTLexicalForm',
    'DISPID_SRCEInterference', 'SVP_1', 'SFTInput',
    'DISPID_SpeechPhraseElements', 'DISPID_SpeechPhraseAlternate',
    'ISpStream', 'SPWT_PRONUNCIATION', 'SSSPTRelativeToStart',
    'ISpeechMMSysAudio', 'DISPID_SBSRead',
    'SpeechCategoryPhoneConverters', 'DISPID_SGRsItem',
    'SpeechSpecialTransitionType', 'SPEI_MAX_TTS',
    'SVSFParseAutodetect', 'SLTApp', 'SpeechMicTraining',
    'DISPID_SOTCreateInstance', 'SAFTDefault', 'DISPID_SVEBookmark',
    'ISpNotifySink', 'DISPIDSPTSI', 'ISpRecoResult',
    'DISPID_SASetState', 'SPGRAMMARWORDTYPE', 'STCLocalServer',
    'eWORDTYPE_ADDED', 'SpWaveFormatEx', 'DISPID_SAFType',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SLWLangId',
    'DISPID_SpeechVoice', 'tagSPPROPERTYINFO',
    'DISPID_SPPEngineConfidence', 'eLEXTYPE_RESERVED7',
    '_RemotableHandle', 'DISPID_SRCEEnginePrivate',
    'STSF_LocalAppData', 'SPVPRIORITY', 'DISPID_SPEDisplayText',
    'DISPID_SpeechObjectTokens', 'ISpeechPhraseReplacements',
    'ISpStreamFormat', 'SSFMCreateForWrite', 'SPPHRASEELEMENT',
    'DISPID_SpeechLexiconWord', 'SVP_5', 'DISPID_SpeechObjectToken',
    'SREFalseRecognition', 'SPCT_SUB_COMMAND',
    'DISPID_SRGDictationUnload', 'eLEXTYPE_PRIVATE10',
    'STCRemoteServer', 'SPEI_RECO_OTHER_CONTEXT', 'SVP_17',
    'SpeechDisplayAttributes', 'DISPID_SASFreeBufferSpace',
    'SPFM_OPEN_READONLY', 'DISPID_SDKSetStringValue', 'SPPHRASE',
    ...
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SLWType', 'SVPAlert',
    'SPCS_ENABLED', 'ISpeechLexicon', 'SGLexicalNoSpecialChars',
    'DISPID_SRRPhraseInfo', 'LONG_PTR', 'UINT_PTR', 'SGSDisabled',
    'SPAS_RUN', 'DISPID_SRGetFormat', 'SECFIgnoreCase',
    'DISPID_SPAStartElementInResult', 'DISPID_SPAs_NewEnum',
    'SPDKL_CurrentConfig', 'SPLOADOPTIONS', 'SAFT16kHz8BitMono',
    'SPSHT_NotOverriden', 'DISPID_SPERequiredConfidence',
    'SPFILEMODE', 'SPEI_MAX_SR', 'DISPID_SRCEPropertyNumberChange',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRCERecognizerStateChange',
    'eLEXTYPE_PRIVATE3', 'DISPID_SLGetGenerationChange',
    'SAFT32kHz16BitMono', 'eLEXTYPE_PRIVATE19',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechPropertyHighConfidenceThreshold',
    'SSTTWildcard', 'SpNotifyTranslator', 'SPSEMANTICERRORINFO',
    'SpCompressedLexicon', 'DISPID_SAEventHandle', 'SBONone',
    'DISPID_SPPParent', 'DISPID_SWFEBlockAlign', 'SGRSTTRule',
    'DISPID_SRRGetXMLResult', 'SVF_None', 'DISPID_SRRGetXMLErrorInfo',
    'SASRun', 'SPBO_TIME_UNITS', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SpeechCustomStream', 'SAFT32kHz16BitStereo',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SDKDeleteValue',
    'DISPID_SGRId', 'SAFT16kHz16BitStereo', 'SpeechAudioFormatType',
    'SpeechInterference', 'DISPID_SRCEPropertyStringChange',
    'SPEI_SR_PRIVATE', 'ISpeechGrammarRuleStateTransitions', 'SVP_9',
    'DISPID_SGRsAdd', '_ISpeechVoiceEvents',
    'DISPID_SOTIsUISupported', 'SPEI_RESERVED5', 'DISPID_SGRsCommit',
    'SPBOOKMARKOPTIONS', 'SPSTREAMFORMATTYPE', 'STCInprocHandler',
    'DISPID_SpeechRecoContextEvents', 'SpeechRecognizerState',
    'eLEXTYPE_PRIVATE13', 'SAFT24kHz16BitMono',
    'DISPID_SVSInputWordLength', 'SpPhoneConverter',
    'SPDKL_LocalMachine', 'SPSHT_Unknown', 'SPSSuppressWord',
    'SPAO_NONE', 'SpeechVoiceSkipTypeSentence', 'SPEI_MIN_TTS',
    'DISPID_SVWaitUntilDone', 'DISPID_SGRSAddWordTransition',
    'DISPID_SLPSymbolic', 'SAFTCCITT_ALaw_44kHzStereo',
    'SP_VISEME_13', 'eLEXTYPE_RESERVED9', 'SPAUDIOSTATE',
    'DISPID_SVEWord', 'SPSMF_SAPI_PROPERTIES', 'SPRULESTATE',
    'SP_VISEME_7', 'SpeechTokenKeyFiles', 'DISPID_SRCESoundEnd',
    'SFTSREngine', 'DISPID_SRGCmdSetRuleIdState', 'SPRST_NUM_STATES',
    'SECLowConfidence', 'DISPID_SOTsCount',
    'DISPID_SLRemovePronunciation', 'SVSFIsNotXML',
    'SPCT_SUB_DICTATION', 'SP_VISEME_12', 'SDTRule',
    'ISpeechResourceLoader', 'SVP_0', 'SpShortcut',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SGRSTPropertyId',
    'ISpeechLexiconPronunciations', 'DISPID_SpeechRecognizer',
    'SPFM_NUM_MODES', 'SRCS_Disabled', 'SPRECORESULTTIMES',
    'SPSEMANTICFORMAT', 'SPEI_UNDEFINED', 'SRSInactive',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SDKOpenKey',
    'eLEXTYPE_PRIVATE6', 'SpObjectToken', 'DISPID_SGRName',
    'SVEWordBoundary', 'SWPUnknownWordUnpronounceable',
    'SpeechCategoryRecoProfiles', 'ISpPhrase',
    'SPDKL_DefaultLocation', 'ISpeechRecognizer',
    'SpeechGrammarTagWildcard', 'DISPID_SOTCId', 'SRSActive',
    'SpeechStreamSeekPositionType', 'SPSERIALIZEDRESULT', 'STCAll',
    'SpeechLexiconType', 'SP_VISEME_2', 'DISPID_SPRuleName',
    'SPPS_SuppressWord', 'SpCustomStream', 'SECFEmulateResult',
    'DISPID_SPISaveToMemory', 'SAFTGSM610_22kHzMono',
    'DISPID_SPIReplacements', 'SPCT_DICTATION',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SLAddPronunciation',
    'STSF_AppData', 'DISPID_SRCResume', 'SSSPTRelativeToEnd',
    'SGRSTTWord', 'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPRsItem',
    'DISPID_SRCCmdMaxAlternates', 'SVP_13',
    'DISPID_SpeechAudioBufferInfo', 'SAFT16kHz16BitMono',
    'SpeechPropertyNormalConfidenceThreshold'
]

_check_version('1.1.14', 1610908380.813462)
